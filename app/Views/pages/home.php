<div id="map-carousel" class="carousel slide" data-bs-ride="true">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active i-item">
      ...
      <div class="carousel-caption top-0 mt-4k">
...
<div id="servercent">
    ...
    <button id="getLocationBtn" type="button" class="bttn_use_location">Use My Location</button>
      <div id="result" class="button_location">
